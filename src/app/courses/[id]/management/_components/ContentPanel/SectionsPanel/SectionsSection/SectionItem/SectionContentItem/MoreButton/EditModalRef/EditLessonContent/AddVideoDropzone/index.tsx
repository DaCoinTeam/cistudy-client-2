import { AlertCircleIcon, FolderClosedIcon, FolderOpenIcon } from "lucide-react"
    ...
    return (
        <div>
            ...
            <div className="flex gap-2 items-center">
                ...
                <div className="text-xs text-warning"> When the upload is complete, the server will require some time to process the video into adaptive bitrate streams. </div>
            </div>
        </div>
    )
}