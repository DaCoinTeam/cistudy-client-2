    ...
    return (
        <div className='relative overflow-hidden '>
            <div className='w-[80%] absolute -z-10]'>
                <Image alt="bg_decoration" className="rounded-none h-[580px] mt-[-1rem]" src={BG_DECORATION} />
            </div>
            <div className='px-2 '>
                ...
                <div className='flex justify-center bg-primary  dark:bg-opacity-80 mx-0 mb-20 py-12 px-6 z-10' >
                    <div className=' w-full '>
                        <div className="flex flex-col justify-around items-center mb-4 text-white">
                            <div className='text-4xl tracking-tight font-extrabold  mb-4'>Our Growing Community</div>
                            <div className="mb-4 font-light dark:text-gray-500 sm:text-xl text-gray-400">Join thousands who are transforming their learning journey with CiStudy.</div>
                        </div>
                ...
                <div className="mt-10 max-w-[1080px] mx-auto px-12 py-12 mb-12">
                    ...
                    Interact
                        ...
                        <div className="col-span-1 px-4  h-full p-8 ">
                            <div className='text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white  mb-4'>Easy steps to learn and earn.</div>
                            <div className="font-light text-gray-500 sm:text-xl dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-10 max-w-[1080px] mx-auto ">
                    <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16 text-center">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Best Instructors</h2>
                    ...
                    <div className="grid grid-cols-5">
                        <div className="flex flex-col items-center">    
                            <Avatar src="https://i.pravatar.cc/150?u=a04258114e29026302d"  className="h-20 w-20 text-large" />
                            <div className="mb-1 text-lg font-semibold tracking-tight text-gray-900 dark:text-white mt-2">Namee ne</div>
                            <div className="font-light text-gray-500 text-sm dark:text-gray-400">Senior Web Developer</div>
