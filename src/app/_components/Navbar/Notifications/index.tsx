...
export const Notifications = () => {
    ...
    const getNotification = useMemo(() => {
        if (!data) return []
        const coursesReturn: Array<NotificationEntity> = []
                ...
                <div className='h-[560px] w-[420px]'>
                    ...
                    >
                        {isLoading ? (
                            ...
                            getNotification.map(({ title, description, notificationId, sender, referenceLink }) => (
                                <div key={notificationId} className=' border-b-1 '>
                                    <Link className="cursor-pointer flex p-4"  onPress={() => router.push(referenceLink)} >
                                        <div >
                                            {sender ? (
                                                <Avatar
                                                    name='avatar'
                                                ...
                                                <Image alt='reward' className='rounded-none w-10 h-10' src={STARCI_COIN} />
                                            )}
